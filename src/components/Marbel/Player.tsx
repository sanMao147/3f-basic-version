import marbleDiff from '@/assets/textures/car/marble_diff.jpg'
import marbleNor from '@/assets/textures/car/marble_nor.jpg'
import marbleRough from '@/assets/textures/car/marble_rough.jpg'
